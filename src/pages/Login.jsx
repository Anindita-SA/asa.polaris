    ...
    <div className="relative h-screen w-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-8 animate-float">
        ...
        <button
          ...
          className="group flex items-center gap-3 mx-auto px-8 py-3 glass border border-pulsar/30 rounded-xl text-starlight text-sm font-body hover:border-pulsar/60 hover:bg-pulsar/10 transition-all"
        >
